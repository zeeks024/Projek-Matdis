...
def send_otp(receiver_email, otp_code):
    ...
    sender_password = "toux xxen ixrn frnx"
    ...
    try:
        ...
        body = (
            ...
            f"Kode ini hanya berlaku selama 1 menit 30 detik. Jangan bagikan kode ini kepada siapa pun.\n\n"
            f"Salam hangat"
        )
...
# Generate a QR code
# for scan with Google Authenticator
